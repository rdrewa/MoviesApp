...
void main() {
  ...
  group('Get watch list', () {
    test('Should return Watch Movies list when call to service is successful',
        () async {
      // arrange
      when(() => mockWatchService.getList())
    ...
    test('Should return database failure when call to service is unsuccessful',
        () async {
      // arrange
